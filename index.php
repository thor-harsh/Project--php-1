<?php
//INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'harry', 'Thank bro', current_timestamp());
$insert=False;
$delete=False;
$update=False;
  ...
  if (isset( $_POST['snoEdit'])){
    ...
    // exit();
      ...
      if($result){
        ...
        echo "The record isn't submitted successfully";
      }
    ...
    $result=mysqli_query($conn,$sql);
    if($result){
      // echo "The record is submitted successfully";
      $insert=True;
    }
    else{
      echo "The record isn't submitted successfully";
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
  ...
  <strong>Success!</strong> Your records has been submitted successfully
    ...
    Array.from(deletes).forEach((element)=>{
      ...
      element.addEventListener("click",(e)=>{
        ...
        if (confirm("Press a button!")){
          console.log('yes');
          window.location=`/crud/index.php?delete=${sno}`;//Template Literals
        }
        else{
          console.log('no');
        }
